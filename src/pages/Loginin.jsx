...
function Loginin() {
    ...
    const dataUsers = {
        "dbarrueta42@gmail.com":"28587583",
    }
    const config = {
        position: "top-right",
        autoClose: 5000,
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:3578/api/controlBusiness/signIn', {
                email: values.email,
            ...
            .then(response => {
                ...
                if (response.data == "") {
                    toast.error( `Error usuario no encontrado.`, config);
                }
            })
            .catch(error => {
                console.log(error.message);
                toast.error(`Error al iniciar sesión recargue la página, por favor.`, config);
            });
    }
                            ...
                            <div className="row justify-content-center">
                                ...
                                <div className="col-12 col-sm-12 col-md-12 mb-2 text-start">
                                    ...
                                    <div className="input-group mb-3">
                                        ...
                                        <input type="email" onChange={(e) => { setValues({...values, 'cedula': e.target.value})}} className="p-1 form-control" id="cedula" name="cedula" placeholder="ingresa tu cédula" aria-label="cedula" aria-describedby="basic-addon1"/>
                                    </div>
                                </div>
                                <div className="col-12 col-sm-12 col-md-12 mb-2 text-start">
